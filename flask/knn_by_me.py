...
def train():
        ...
        for image_path in image_files_in_folder(os.path.join(train_folder, folder_name)):
            ...
            if len(face_detected) != 1:
                ...
                with open (csv_fail, mode='a', newline='') as file:
                    ...
                    writer.writerow([image_counter, folder_name, image_path, "Wajah tidak terdeteksi" if len(face_detected) < 1 else "Wajah terdeteksi lebih dari 1"])
            ...
            # Jika wajah = 1
                ...
                with open (csv_success, mode='a', newline='') as file:
                    writer = csv.writer(file)
                    writer.writerow([image_counter, folder_name, image_path])
    ...
    if os.path.isfile(model_save_path):
        ...
        if len(knn_clf._fit_X) > 0 and len(X) > 0:
            ...
            print("Tidak ada data baru untuk ditambahkan ke model yang sudah ada")
    else:
